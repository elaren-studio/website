...
Plausible account ownership and matching custom-event goals are deferred by the owner as of September 9, 2026. Do not request sign-in again unless the owner resumes this work. Do not report these as a verified conversion dashboard until both goal setup and event readback succeed. Existing pageviews and the private ledger remain distinct. Exclude labeled synthetic form checks from conversion interpretation. Source page means the form used, not necessarily the original acquisition channel.
